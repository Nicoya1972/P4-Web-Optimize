...
var resizePizzas = function(size) {
    ...
    function changePizzaSizes(size) {
        //created a var to acapture document.getElementsByClassName to use for other vars to make coding more cleaner.
        var pizzaElements = document.getElementsByClassName("randomPizzaContainer");
        //moved vars dx and newwidth out for loop for better performance. 
...
function updatePositions() {
    ...
    //moved both mover and scrolltop out of loop for better performance since they both are only excecuted once.
